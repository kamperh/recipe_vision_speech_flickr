...
"""
Train a visually grounded spoken bag-of-words CNN with a custom pooling layer.
...
from train_bow_cnn_custompool import build_bow_cnn_custompool_from_options_dict
import data_io
